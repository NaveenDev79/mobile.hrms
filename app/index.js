...
const App = () => {
    ...
    return (
        <SafeAreaView className="">
            ...
            <View className="bg-[#f2984a] flex justify-evenly rounded-t-3xl py-2 px-1 basis-2/5">
                <View className="px-2">
                ...
                <View>
                    <TouchableOpacity onPress={()=>router.push('/login')} className="bg-slate-50 p-2 rounded-lg">
                        <Text className="text-center text-2xl   font-bold" >sign in</Text>
                    </TouchableOpacity>
                    <TouchableOpacity onPress={()=>router.push('/Home')} className="bg-slate-50 mt-2 p-2 rounded-lg">
